...
const Shop = () => {
  ...
  return (
    <div className='min-h-screen bg-gray-50'>
      <button
        className='cursor-pointer absolute top-4 left-4 z-20 flex items-center gap-2 bg-black/50 hover:bg-black/70 text-white px-3 py-2 rounded-full shadow-md transition'
        onClick={() => navigate('/')}
      >
        <FaArrowLeft />
        <span>Back</span>
